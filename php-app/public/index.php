...
function whatsappLink(string $number, string $name, string $price, bool $available): string {
    $message = $available
        ? "Halo Geo Booster, saya tertarik dengan {$name} ({$price}). Mohon info detail dan prosesnya."
        : "Halo Geo Booster, saya ingin mendapat notifikasi saat {$name} ({$price}) tersedia kembali.";
...
<head>
    ...
    <meta name="description" content="Geo Booster — katalog produk digital dengan proses yang jelas, cepat, dan aman.">
    <title><?= e($app['name']) ?> — Digital access, made clear.</title>
    <link rel="stylesheet" href="/assets/style.css">
</head>
<body>
<header class="site-header"><a class="brand" href="#top" aria-label="Geo Booster home"><span class="brand-mark">G</span><span>Geo<span class="brand-accent">Booster</span></span></a><nav class="nav" aria-label="Navigasi utama"><a href="#catalog">Katalog</a><a href="#how-it-works">Cara kerja</a><a href="#faq">FAQ</a></nav><a class="header-cta" href="<?= e($app['support_url']) ?>" target="_blank" rel="noopener">Chat support <span>↗</span></a></header>
<main id="top">
<section class="hero section-shell"><div class="hero-copy"><div class="pill"><span class="pulse"></span> <?= count(array_filter($products, fn(array $p): bool => $p['available'])) ?> produk tersedia</div><h1>Produk premium.<br><em>Jelas</em> sejak awal.</h1><p class="hero-lead">Pilih produk digital yang kamu butuhkan, lihat harga dan statusnya, lalu langsung chat Geo Booster melalui WhatsApp.</p><div class="hero-actions"><a class="button button-primary" href="#catalog">Lihat katalog <span>↓</span></a><a class="text-link" href="#how-it-works">Cara order <span>↗</span></a></div><div class="mini-proof"><div class="avatars"><i>G</i><i>B</i><i>W</i><i>+</i></div><span><strong><?= count($products) ?> SKU</strong> sudah masuk katalog</span></div></div><div class="hero-art" aria-label="Ilustrasi Geo Booster"><div class="orbit orbit-one"></div><div class="orbit orbit-two"></div><div class="float-card card-top"><span class="card-dot"></span><b>WHATSAPP ORDER</b><small>Langsung terhubung ke tim</small></div><div class="main-orb"><div class="orb-grid"></div><span>G<span class="brand-accent">B</span></span></div><div class="float-card card-bottom"><span class="check">✓</span><div><b>Clear pricing</b><small>Status tersedia terlihat</small></div></div><div class="spark spark-one">✦</div><div class="spark spark-two">✧</div></div></section>
...
</main><footer class="site-footer"><div class="section-shell footer-inner"><a class="brand" href="#top"><span class="brand-mark">G</span><span>Geo<span class="brand-accent">Booster</span></span></a><p>Digital access, made clear.</p><span>© <?= date('Y') ?> Geo Booster</span></div></footer>
